...
- Actual VS Marketplace / Open VSX **publish** (credentials + first listing).
  ...
  `extensions/vscode/`.
- `lint --fix --ai` (apply AI-generated edits) and local/Ollama providers
  remain follow-ups beyond the v0.21 print-only AI breadth.

## Shipped

- ✅ **AI breadth catch-up** (v0.21.0) — `lint --ai`, config `ai`, suggest
  flags, VS Code command palette wrappers.
