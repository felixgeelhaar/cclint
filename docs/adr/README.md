...
| [005](005-plugin-security-sandbox.md)     | Plugin Security Sandbox                        | Superseded  |
| [006](006-anthropic-alignment-v0.5.0.md)  | Anthropic Official Guidance Alignment (v0.5.0) | Accepted    |
| [007](007-v0.7.0-developer-experience.md) | v0.7.0 Developer Experience Features           | Accepted    |
| [008](008-v0.8.0-lsp-integration.md)      | v0.8.0 LSP Integration Strategy                | Accepted    |
...
| [011](011-claude-code-extended-features.md) | Claude Code Extended Features                | Accepted    |

## Creating a New ADR

1. Copy the template from `000-template.md`
2. Number it sequentially (e.g., `012-your-decision.md`)
